...
package Vo.Lib {
    ...
    public class ChineseTopym
    {

        public function ChineseTopym():void
        {

        }

        public  function ChineseTo(chinese:String):String
        {
        ...
        private function isIn(from:int, to:int, value:int):Boolean
        {
         ...
         */
        public function isChinese(chineseChar:String):Boolean
        {
 ...
 * 定义转换拼音码
 **/
public var pym:ChineseTopym=new ChineseTopym();
new ChineseTopym().ChineseTo(StringUtil.trim(this.txt_ypcdName.text))
```